      ...
      <form @submit.prevent="onSubmit">
        <b-tabs type="is-boxed" :animated="false">
          <b-tab-item label="General">
            <div class="items">
              <b-field label="Root URL"
                message="Public root URL of the listmonk installation that'll be used
                        in the messages for linking to images, unsubscribe page etc.">
                <b-input v-model="form['app.root_url']" name="app.root_url"
                    placeholder='https://listmonk.yoursite.com' :maxlength="200" />
              </b-field>
          ...
          <b-tab-item label="Media uploads">
            <div class="items" v-if="form['upload.provider']">
